...
class Ui_NV200Widget(object):
    def setupUi(self, NV200Widget):
        ...
        self.deviceSearchWidget = DeviceSearchWidget(NV200Widget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 270, 668))
        ...
        sizePolicy4.setHeightForWidth(self.moveButton_2.sizePolicy().hasHeightForWidth())
        self.moveButton_2.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.moveButton.sizePolicy().hasHeightForWidth())
        self.moveButton.setSizePolicy(sizePolicy4)
        ...
        sizePolicy3.setHeightForWidth(self.freqSpinBox.sizePolicy().hasHeightForWidth())
        self.freqSpinBox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.phaseShiftSpinBox.sizePolicy().hasHeightForWidth())
        self.phaseShiftSpinBox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.highLevelSpinBox.sizePolicy().hasHeightForWidth())
        self.highLevelSpinBox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.lowLevelSpinBox.sizePolicy().hasHeightForWidth())
        self.lowLevelSpinBox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.startWaveformButton.sizePolicy().hasHeightForWidth())
        self.startWaveformButton.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.stopWaveformButton.sizePolicy().hasHeightForWidth())
        self.stopWaveformButton.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.piezoIconLabel.sizePolicy().hasHeightForWidth())
        self.piezoIconLabel.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.consoleButton.sizePolicy().hasHeightForWidth())
        self.consoleButton.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.consoleWidget.sizePolicy().hasHeightForWidth())
        self.consoleWidget.setSizePolicy(sizePolicy5)
